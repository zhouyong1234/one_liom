...
main (int argc, char** argv)
{
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZ> ("/home/touchair/sensor_fusion_ws/src/one_liom/test_icp/data/x_5/34laser.pcd", *target_cloud) == -1)
  {
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZ> ("/home/touchair/sensor_fusion_ws/src/one_liom/test_icp/data/x_5/34map.pcd", *input_cloud) == -1)
  {
